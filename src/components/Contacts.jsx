  ...
  return (
    ...
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <br />
          <p className="py-1">Submit the form below to get in touch with me</p>
        </div>

        <div className=" flex justify-center items-center">
          <form
            action="https://getform.io/f/be676763-2c91-4dea-b3de-6dd87a7ce6bd"
            method="POST"
          ...
          >
            ...
            from-cyan-500 to-orange-500 px-6 py-3 my-8 mx-auto
